...
public class WinFlag extends Interactable {
    ...
    public WinFlag(Vector2 position, String label, InteractionTarget target) {
    ...
    public void addCollision() {
        ...
        if (collisions == 1) {
            System.out.println("WinFlag activated with " + collisions + " collisions.");
            interact();
        }
    }

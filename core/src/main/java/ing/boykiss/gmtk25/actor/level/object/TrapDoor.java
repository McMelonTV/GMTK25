...
public class TrapDoor extends Targetable {
    ...
    public TrapDoor(Vector2 position, String label) {
        super(position, label);
    }

    public TrapDoor(Vector2 position, String label, boolean isOpen) {
        this(position, label);
        this.initialState = new Nullean(false, isOpen);
        this.isOpen = isOpen;
    }

    public TrapDoor(Vector2 position, String label, Supplier<Boolean> stateGetter) {
        this(position, label);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(currentFrame,
            ...
            currentFrame.getRegionWidth() * Constants.UNIT_SCALE * 0.5f,
            currentFrame.getRegionHeight() * Constants.UNIT_SCALE * 0.5f,
    ...
    Body createBody(World world) {
        ...
        shape.setAsBox(12.0f * Constants.UNIT_SCALE, 2.0f * Constants.UNIT_SCALE);
